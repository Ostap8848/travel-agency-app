...
<div class="col-md-8 text-end">
    <a href = "home?command=adminListOfTours" role="button"
       class="btn btn-outline-primary me-2"><fmt:message key="index.allTours"/></a>
    <a href = "home?command=allUsers" role="button" class="btn btn-primary"><fmt:message key="index.allUsers"/></a>
</div>
<br>
    ...
    <c:forEach var="tour" items="${tours}">
        <tr>
            ...
            <td><form action="home" method="get">
                <input hidden name="command" value="setTourStatus">
                <select name="tourStatus">
                    <option disabled><fmt:message key="index.byHotelType"/></option>
                    <option value="REGISTERED"><fmt:message key="index.registered"/></option>
                    <option value="PAID"><fmt:message key="index.paid"/></option>
                    <option value="CANCELED"><fmt:message key="index.canceled"/></option>
                </select><p><input type="submit" value="<fmt:message key="index.applyChanges"/>"/></p>
            </form></td>
        </tr>
    </c:forEach>
    <br>
