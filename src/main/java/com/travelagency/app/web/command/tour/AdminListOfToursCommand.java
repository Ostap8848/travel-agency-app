...
public class AdminListOfToursCommand implements ActionCommand {
    private static final Logger LOG = LogManager.getLogger(AdminListOfToursCommand.class);
    private final TourService tourService;


    public AdminListOfToursCommand(TourService tourService) {
