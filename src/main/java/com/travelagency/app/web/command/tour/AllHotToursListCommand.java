...
public class AllHotToursListCommand implements ActionCommand {
    private static final Logger LOG = LogManager.getLogger(AllHotToursListCommand.class);
    private final TourService tourService;


    public AllHotToursListCommand(TourService tourService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        ...
        try {
            tours = tourService.getAllHotTours(page);
