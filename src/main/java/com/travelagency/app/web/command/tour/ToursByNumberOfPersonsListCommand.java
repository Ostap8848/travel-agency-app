...
public class ToursByNumberOfPersonsListCommand implements ActionCommand {
    private static final Logger LOG = LogManager.getLogger(ToursByNumberOfPersonsListCommand.class);
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        ...
        try {
            tours = tourService.getToursByNumberOfPersons(page);
